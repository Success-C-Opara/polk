pipeline {
    ...
    environment {
        EC2_USER = 'ec2-user'
        EC2_HOST = '3.208.24.205'
        PRIVATE_KEY_PATH = 'C:/Users/Success/Downloads/test1fikun.pem'
        IMAGE_NAME = 'successwise1/polk'
        IMAGE_TAG = "build-${env.BUILD_NUMBER}"
        GIT_REPO = 'https://github.com/Success-C-Opara/polk.git'
        BRANCH_NAME = 'master'
